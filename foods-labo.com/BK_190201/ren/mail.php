...
//$admin_to_list[] = 'web-check@jgrip.co.jp';
...
<?php
		...
		header("Location: ".$thanksPage."?m=".orderNumber($_POST['電話番号']));
	}
}
...
function orderNumber($str) {
	...
	return urlencode(md5(h($replace)));
}
...
//	$resArray .= "【 エントリーNO 】 ".$entryno."\n";
	...
	$resArray .= "【注文番号】".orderNumber($arr['電話番号'])."\n";
	return $resArray;
}
//確認画面の入力内容出力用関数
